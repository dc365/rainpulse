...
elevation, and atomically emits `RadarGrid` v1.2 plus polar diagnostics. The
...
Later tasks replace the remaining synthetic mosaic/input executors one at a time while
