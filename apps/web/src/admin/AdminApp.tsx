...
function AdminShell({ token, view, navigate, logout }: {
 ...
 {health.data && !health.data.database_ready && <Notice error>管理表尚未初始化或未升级。请按部署说明依次运行 operations/schema.sql 和 schema_v2.sql；天气工作台不受影响。</Notice>}
