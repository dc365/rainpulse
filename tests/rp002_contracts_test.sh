...
required_files=(
  ...
  "contracts/data/radar-qc-label-manifest.md"
  "contracts/data/radar-phase-processing-artifact.md"
  "contracts/data/radar-attenuation-artifact.md"
  "contracts/data/radar-relative-bias-artifact.md"
  "contracts/data/radar-calibration-reference-manifest.md"
  "contracts/data/radar-attenuation-coefficient-table.md"
