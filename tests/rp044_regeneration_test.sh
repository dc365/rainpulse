...
rg --quiet --fixed-strings 'REGEN_STEPS_CONFIG:-configs/nowcast/prelaunch-pysteps-steps-v6.yaml' scripts/regenerate_forecasts.sh
rg --quiet --fixed-strings 'REGEN_LK_CONFIG:-configs/nowcast/prelaunch-pysteps-lk-v2.yaml' scripts/regenerate_forecasts.sh
